...
invoiceRoutes.get('/', requirePermission(Permissions.INVOICE_VIEW), (req, res, next) => invoiceController.listInvoices(req, res, next));
invoiceRoutes.get('/quotation/:quotationId', requirePermission(Permissions.INVOICE_VIEW), (req, res, next) =>
